...
class FieldAccess : public LValue 
{
  ...
  public:
    ...
    void PrintChildren(int indentLevel);
    char* Name(){return field->GetName();}
    char* CheckExpr();
};
